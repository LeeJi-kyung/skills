...
Claude Code project map for an 8-hour Vibe Coding Hackathon.
...
## Where To Look
- `ARCHITECTURE.md`: API, data, env, FE/BE boundaries
...
- `.claude/agents/`: focused Claude subagents
- `.claude/commands/`: slash commands for repeated flows
